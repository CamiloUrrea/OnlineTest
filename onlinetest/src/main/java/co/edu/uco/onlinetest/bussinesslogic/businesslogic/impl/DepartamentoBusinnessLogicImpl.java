package co.edu.uco.onlinetest.bussinesslogic.businesslogic.impl;
...
public class DepartamentoBusinnessLogicImpl implements DepartamentoBusinessLogic {

    private DAOFactory factory;

    public DepartamentoBusinnessLogicImpl(DAOFactory factory) {
