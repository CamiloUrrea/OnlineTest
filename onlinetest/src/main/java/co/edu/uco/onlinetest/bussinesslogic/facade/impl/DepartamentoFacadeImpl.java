package co.edu.uco.onlinetest.bussinesslogic.facade.impl;

import co.edu.uco.onlinetest.bussinesslogic.businesslogic.DepartamentoBusinessLogic;
import co.edu.uco.onlinetest.bussinesslogic.businesslogic.domain.DepartamentoDomain;
import co.edu.uco.onlinetest.bussinesslogic.businesslogic.impl.DepartamentoBusinnessLogicImpl;
import co.edu.uco.onlinetest.bussinesslogic.facade.DepartamentoFacade;
...
public class DepartamentoFacadeImpl implements DepartamentoFacade {
    ...
    public DepartamentoFacadeImpl() throws OnlineTestException {
        ...
        departamentoBusinessLogic = new DepartamentoBusinnessLogicImpl(daoFactory);
